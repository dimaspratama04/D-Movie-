  ...
  return (
    <>
      ...
      <section className="extras">
        <div className="extras-1" data-aos="fade-right" data-aos-duration="500">
        ...
        <div className="extras-2" data-aos="fade-right" data-aos-duration="500">
        ...
        <div className="extras-3" data-aos="fade-right" data-aos-duration="500">
